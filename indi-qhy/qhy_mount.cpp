/*
    ...
    along with the QHY Mount INDI driver.  If not, see <http://www.gnu.org/licenses/>.
...
static std::unique_ptr<QHYMountBase> qhy_mount(new QHYMountBase());
